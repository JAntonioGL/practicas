...
const userController = require('../controllers/userControllerJSON.js'); //importación de funciones controladores para las peticiónes


const router = express.Router(); //definición para las rutas en express

router.get('/', userController.getAllUsers);//petición GET para obtener los usuarios existentes
